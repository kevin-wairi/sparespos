...
const printReciept = useReactToPrint ({
  ...
  return (
    <div className="d-flex container-fluid justify-content-end p-0 bg-cyan-500" style={{height:'100vh',minWidth:'95vw',width:'95vw'}}>
      {/* overall div */}
      <div className='d-flex  bg-light overflow-hidden ' style={{height:'100vh',width:'95vw',boxShadow:'rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px'}}>
