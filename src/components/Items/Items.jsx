...
import './Items.css'
import {carSparePartsCategories} from '../../Pages/ArrayFiles/CarSparePartsCategories'
import {carModelsYears} from '../../Pages/ArrayFiles/CarModelsYears'
import {carModels} from '../../Pages/ArrayFiles/CarModel'
import {carMakes} from '../../Pages/ArrayFiles/CarMakes'
      ...
      <div className="row d-flex justiy-content-start">
        {
          allFilteredSpares.map((item)=>(
            ...
            <div className="card border-0 text-start mb-2 " style={{width: '10rem',height: '16rem'}}>
              ...
              <div className="card-body p-1">
                <p className=" card-title text-wrap">{item.title}</p>
                <p className="card-text"><span className='fw-bold'>Ksh. </span>{item.markedPrice}</p>
              </div>
            </div>
            </div>
          ))
