...
import { faHouse,faBoxesStacked,faUser,faX,faDoorOpen,faTableList ,faCartShopping} from '@fortawesome/free-solid-svg-icons';
      ...
      <div className=' sidebarmenu overflow-x-hidden overflow-y-scroll ' style={{ maxHeight: '100vh' }} id='sidebar'>
        <div className="wrapper rounded">
          ...
          <ul className="nav nav-pills mx-2 ">
            ...
            <li className={`nav-item mx-md-3 text-start sidebar-link my-1 flex-fill  rounded ${isNavLinkActive('/signin') ? 'active' : ''}`}>
            <NavLink  to="/signin"  >
              <a href="#" className="nav-link p-0 d-flex gap-2 p-1" aria-current="page">
